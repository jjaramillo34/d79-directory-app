...
const Step9ServiceInSchoolsPlan = ({ stepData, updateStepData, isActive }) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-blue-700 text-sm">
            This step establishes protocols for Service learning and community engagement programs_LOWER.
          </p>
        </div>
