    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-semibold text-blue-800">What This Step Covers</span>
          </div>
          <p className="text-blue-700 text-sm">
            This step confirms your understanding of the 15-step school plan structure and prepares you for the comprehensive planning process.
          </p>
        </div>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-semibold text-green-800">Getting Started</span>
          </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-blue-800">Ready to Proceed?</span>
        </div>
