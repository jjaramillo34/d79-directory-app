...
const Step14CellPhonePolicy = ({ stepData, updateStepData, isActive }) => {
  const [questions] = useState(() => {
    const step = formQuestionsData.steps.find(s => s.key === 'cellPhonePolicy');
  ...
  const handleInputChange = (questionId, value) => {
    ...
    updateStepData('cellPhonePolicy', newFormData);
  };
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-blue-600">
              Cell phone policy implementation and compliance
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-blue-700 text-sm">
            This step establishes protocols for Cell phone policy implementation and compliance_LOWER.
          </p>
        </div>
...
export default Step14CellPhonePolicy;
